...
public class PU_IGT_TW_LINE extends Structure {
	 ...
	 * C type : CHAR[(32 + 4)]
	 */
	public PU_IGT_TW_LINE(UCHAR ucDirection, PU_IGT_POINT stStartPoit, PU_IGT_POINT stEndPoit, NativeLong ulLineIndex, boolean bEnable, byte szLineName[]) {
		super();
