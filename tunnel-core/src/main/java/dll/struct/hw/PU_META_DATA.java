...
public class PU_META_DATA extends Structure {
	...
	/** C type : PU_UserData* */
	public dll.struct.PU_UserData.ByReference pstMetaUserData;
	public PU_META_DATA() {
		super();
	}
	...
	public PU_META_DATA(short usCapacity, short usValidNumber, dll.struct.PU_UserData.ByReference pstMetaUserData) {
		super();
