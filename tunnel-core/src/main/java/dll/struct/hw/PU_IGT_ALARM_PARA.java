...
import dll.library.HWPuSDKLibrary.UCHAR;
...
public class PU_IGT_ALARM_PARA extends Structure {
	 ...
	 * C type : UCHAR[32]
	 */
	public UCHAR[] szReserved = new UCHAR[32];
	 ...
	 * C type : UCHAR[32]
	 */
	public PU_IGT_ALARM_PARA(NativeLong ulChannelId, boolean bIgtEnable, boolean bTrackEnable, int enFieldType, int enMinTargetSize, int enShadowMode, int enDetectSens, boolean bInsensitiveObject, UCHAR szReserved[]) {
		super();
