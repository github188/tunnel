...
public class PU_PIC_OSD_INFO_S extends Structure {
	 ...
	 * C type : UCHAR
	 */
	public PU_PIC_OSD_INFO_S(int uPicOSDNum, int aenPicOSDType[], int enPicOSDLocation, int enFontSize, NativeLong ulFgColor, UCHAR ucFgAlpha, NativeLong ulBgColor, UCHAR ucBgAlpha) {
		super();
